...
public class ProcessLauncher
{
    ...
    private int execute()
    {
        ...
        if (err == null)
        {
            ...
            {
                Logger.getLogger(ProcessLauncher.class.getName()).log(
                        Level.SEVERE,
                                                                      null,
                                                                      ex);
            }
        ...
        {
            createStreamThread(process.getErrorStream(),
                               err);
        }
        if (out == null)
        {
        ...
        {
            createStreamThread(process.getInputStream(),
                               out);
        }
    ...
    private void createStreamThread(final InputStream is,
